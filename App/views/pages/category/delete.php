<div class="page-content">
      <? self::components( 'breadcrumb' , [ 'Kategori' , 'Sil' , 'style' => 'color:purple;' ]  ); ?>
                  ...
                  self:: headerLocation( 3 , 'category/read' ); // Page -> Redirection
                   ...
                   if( isset( $_POST['categoryDelete'] ) ):
                         if( $data ):
                               ...
                               self:: headerLocation( 3 , 'category/read' ); // Page -> Redirectio
                         endif;
                   else:
                                                 ...
                                                 <div class="flexItem card">
                                                       ...
                                                       <div class="flex flexRow">
                                                             <div class="flexItem">
                                                                   ...
                                                                   <textarea readonly class="form-control" minlength="100" maxlength="165" name="description" placeholder="Kategori Açıklama :" id="exampleFormControlTextarea1" rows="2"><?=$items['description'];?></textarea>
                                                             </div>
                                                       </div>
                                                       <div class="flex flexRow">
                                                             <div class="flexItem text-right">
                                                                   <button type="submit" name="categoryDelete" class="margin-bottom-20 margin-top-20 submitBTN btn btn-danger yazi_700 Chakra" style="color:black;" >
                                                                           SİL
                                                                   </button>
                                                             </div>
                                                       </div>
                                      ...
                                      <? else: ?>
                                          ...
                                          <div class="flex flexRow">
                                               ...
                                               <div class="flexItem card">
                                                     ...
                                                     <div class="flex flexRow">
                                                           <div class="flexItem text-right">
                                                                 <button type="submit" name="categoryDelete" class="margin-bottom-20 margin-top-10 submitBTN btn btn-danger yazi_700 Chakra" style="color:black;" >
                                                                         SİL
                                                                 </button>
                                                           </div>
                                                     </div>
