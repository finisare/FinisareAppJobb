<? self::components( 'title' , 'Dashboard' ); ?>

<div class="page-content">
       <div class="page-info">
           <? self::components( 'breadcrumb' ); ?>
       </div>
                     ...
                     <div class="card top-products">
                         <div class="card-body">
                             <h5 class="card-title" style="text-transform:none;">
                                 GİRİŞ İŞLEMLERİ
                                 <span class="card-title-helper">Today</span>
                             </h5>
                             <div class="top-products-list">
                                 <? foreach( $data['userLoginData'] as $loginData ): ?>
                                         <div class="product-item " >
                                               <h5 class="text-black" style="text-transform:none; font-weight:bold;"><?= $loginData['user']; ?></h5>
                                               <span><?= $loginData['datee'].'<br/>'.$loginData['ip_adres']; ?></span>
                                               <? if( $loginData['checkLogin'] ): ?>
                                                   <i class="material-icons product-item-status product-item-success">assistant_navigation</i>
                                               <? else: ?>
                                                   <i class="material-icons product-item-status product-item-danger">cancel</i>
                                               <? endif; ?>
                                         </div>
                                 <? endforeach; ?>
                             </div>
