...
sNext:"&nbsp; <span class='material-icons'>keyboard_double_arrow_right</span>",sPrevious:"<span class='material-icons'>keyboard_double_arrow_left</span> &nbsp; "},sEmptyTable:"TABLODA VERİ YOK",sInfo:"Showing _START_ to _END_ of _TOTAL_ entries",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"İlk _MENU_ veri",sLoadingRecords:"Yükleniyor...",sProcessing:"İşleme...",sSearch:"Arama:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Hiçbir eşleşen kayıt bulunamadı"},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",
